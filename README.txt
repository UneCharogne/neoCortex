...
**** INPUT ****
There is an input example called “configurations.dat” which contains 4000 configurations of 2D Ising model with 400 spins at 40 different temperatures, going from T=1.0 to T=4.9 with dT=0.1 (100 independent configurations per temperature). 
Each line contains a configuration x=(s1,s2,…,s400). Configurations are ordered per temperature from lowest to highest.
