          ...
          case white_pawn:
            ...
            if((square < 56) && (this->board[square + 8] == empty)) {
              ...
              if(ChessState::isUnderAttack(newBoard, newKingPositions[0], -1 * this->player) == false)
              {
                  ...
                  if(DEBUG_MODE == 1) {
                      std::cout << "Move name: " << moveName << ", move id: " << MovesDictionary[moveName] << "\n";
                  }
...
std::vector<double> ChessState::getNetworkInput(void) {
  ...
  if(this->player == 1) {
      ...
      for(int square=0;square<64;square++) {
          if((this->board[square] == black_pawn) || (this->board[square] == black_pawn2)) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[square] == black_rook) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[square] == black_knight) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[square] == black_bishop) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[square] == black_queen) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if((this->board[(63 - square)] == white_pawn) || (this->board[(63 - square)] == white_pawn2)) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[(63 - square)] == white_rook) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[(63 - square)] == white_knight) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[(63 - square)] == white_bishop) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[(63 - square)] == white_queen) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
      ...
      for(int square=0;square<64;square++) {
          if(this->board[(63 - square)] == white_king) {
              netInput.push_back(1);
          }
          else{
              netInput.push_back(0);
